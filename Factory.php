 ...
 * @method Validator make(array $data,array $rules,array $messages=[],array $customAttributes = [])
 */
class Factory extends BaseFactory
{
    ...
    {
        return new Validator($this->getTranslator(), $data, $rules, $messages, $customAttributes);
    }
